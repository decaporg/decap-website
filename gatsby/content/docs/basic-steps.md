...
The most common backends are GitHub, GitLab, Bitbucket, and Azure. The backend serves two purpose: Secure access to your website's Decap CMS and allows it to read and update content files in your git repo. See the ["Backends Overview" guide](/docs/backends-overview/) to learn more.
...
Check out the ["Configuration Options" reference](/docs/configuration-options/) for full details about all available options.
