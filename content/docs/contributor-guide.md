...
The documentation for Decap CMS is written in [Markdown](https://daringfireball.net/projects/markdown/) (learn more with this [good Markdown cheatsheet](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet)), with the source residing on [GitHub](https://github.com/decaporg/decap-website).
