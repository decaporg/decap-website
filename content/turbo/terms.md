...
Decap CMS codebase itself, which remains separately licensed under the MIT License. You retain
...
This is separate from the governing law that applies to the payment transaction itself, which
