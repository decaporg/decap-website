...
description: "Last updated: 2026-08-21."
---
...
The Service depends on third-party infrastructure we don't control, including GitHub's and GitLab's APIs, our hosting providers, [Supabase](https://supabase.com), and [Paddle](https://www.paddle.com). We're not responsible for outages, rate limits, API changes, or service interruptions caused by these third parties, though we'll work to minimize their impact on you where we reasonably can.
...
We aim to keep the Service available and reliable, but we don't guarantee uninterrupted or error-free performance. The Service may be unavailable from time to time for maintenance, upgrades, or issues outside our reasonable control.
